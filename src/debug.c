...
// Script menu
static const u8 sDebugText_Util_Script_1[] = _("Clear Daily Flags Script");
...
static void DebugAction_PCBag_Fill_PocketItems(u8 taskId)
{
    if (CheckBagHasSpace(ITEM_POTION, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_POTION, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SUPER_POTION, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SUPER_POTION, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HYPER_POTION, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HYPER_POTION, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAX_POTION, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAX_POTION, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FULL_RESTORE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FULL_RESTORE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_REVIVE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_REVIVE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAX_REVIVE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAX_REVIVE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FRESH_WATER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FRESH_WATER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SODA_POP, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SODA_POP, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LEMONADE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LEMONADE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MOOMOO_MILK, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MOOMOO_MILK, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ENERGYPOWDER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ENERGYPOWDER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ENERGY_ROOT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ENERGY_ROOT, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HEAL_POWDER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HEAL_POWDER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_REVIVAL_HERB, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_REVIVAL_HERB, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ANTIDOTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ANTIDOTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PARLYZ_HEAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PARLYZ_HEAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BURN_HEAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BURN_HEAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ICE_HEAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ICE_HEAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_AWAKENING, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_AWAKENING, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FULL_HEAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FULL_HEAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ETHER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ETHER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAX_ETHER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAX_ETHER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ELIXER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ELIXER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAX_ELIXER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAX_ELIXER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BERRY_JUICE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BERRY_JUICE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SACRED_ASH, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SACRED_ASH, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LAVA_COOKIE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LAVA_COOKIE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HP_UP, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HP_UP, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PROTEIN, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PROTEIN, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_IRON, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_IRON, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_CALCIUM, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_CALCIUM, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ZINC, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ZINC, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_CARBOS, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_CARBOS, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PP_UP, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PP_UP, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PP_MAX, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PP_MAX, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RARE_CANDY, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RARE_CANDY, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLUE_FLUTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLUE_FLUTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_YELLOW_FLUTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_YELLOW_FLUTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RED_FLUTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RED_FLUTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLACK_FLUTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLACK_FLUTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_WHITE_FLUTE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WHITE_FLUTE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_REPEL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_REPEL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SUPER_REPEL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SUPER_REPEL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAX_REPEL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAX_REPEL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_X_ATTACK, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_X_ATTACK, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_X_DEFEND, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_X_DEFEND, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_X_SPECIAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_X_SPECIAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_X_SPEED, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_X_SPEED, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_X_ACCURACY, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_X_ACCURACY, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DIRE_HIT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DIRE_HIT, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_GUARD_SPEC, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_GUARD_SPEC, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_POKE_DOLL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_POKE_DOLL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FLUFFY_TAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FLUFFY_TAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_NUGGET, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_NUGGET, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_TINYMUSHROOM, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_TINYMUSHROOM, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BIG_MUSHROOM, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BIG_MUSHROOM, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PEARL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PEARL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BIG_PEARL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BIG_PEARL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_STARDUST, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_STARDUST, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_STAR_PIECE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_STAR_PIECE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SHOAL_SALT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SHOAL_SALT, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SHOAL_SHELL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SHOAL_SHELL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RED_SHARD, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RED_SHARD, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLUE_SHARD, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLUE_SHARD, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_YELLOW_SHARD, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_YELLOW_SHARD, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_GREEN_SHARD, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_GREEN_SHARD, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HEART_SCALE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HEART_SCALE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RARE_BONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RARE_BONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ORANGE_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ORANGE_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HARBOR_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HARBOR_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_GLITTER_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_GLITTER_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MECH_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MECH_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_WOOD_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WOOD_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_WAVE_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WAVE_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BEAD_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BEAD_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SHADOW_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SHADOW_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_TROPIC_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_TROPIC_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DREAM_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DREAM_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FAB_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FAB_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RETRO_MAIL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RETRO_MAIL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FIRE_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FIRE_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_WATER_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WATER_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_THUNDERSTONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_THUNDERSTONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LEAF_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LEAF_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SUN_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SUN_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MOON_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MOON_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DRAGON_SCALE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DRAGON_SCALE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_UP_GRADE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_UP_GRADE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_EVERSTONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_EVERSTONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LIGHT_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LIGHT_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_STICK, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_STICK, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_THICK_CLUB, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_THICK_CLUB, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LUCKY_PUNCH, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LUCKY_PUNCH, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_METAL_POWDER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_METAL_POWDER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DEEPSEASCALE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DEEPSEASCALE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DEEPSEATOOTH, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DEEPSEATOOTH, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SOUL_DEW, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SOUL_DEW, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SEA_INCENSE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SEA_INCENSE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LAX_INCENSE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LAX_INCENSE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_RED_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_RED_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLUE_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLUE_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PINK_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PINK_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_GREEN_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_GREEN_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_YELLOW_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_YELLOW_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MACHO_BRACE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MACHO_BRACE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SILK_SCARF, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SILK_SCARF, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_CHARCOAL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_CHARCOAL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MYSTIC_WATER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MYSTIC_WATER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MAGNET, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MAGNET, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MIRACLE_SEED, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MIRACLE_SEED, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_NEVERMELTICE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_NEVERMELTICE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLACKBELT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLACKBELT, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_POISON_BARB, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_POISON_BARB, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SOFT_SAND, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SOFT_SAND, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SHARP_BEAK, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SHARP_BEAK, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_TWISTEDSPOON, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_TWISTEDSPOON, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SILVERPOWDER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SILVERPOWDER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_HARD_STONE, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_HARD_STONE, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SPELL_TAG, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SPELL_TAG, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DRAGON_FANG, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DRAGON_FANG, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BLACKGLASSES, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BLACKGLASSES, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_METAL_COAT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_METAL_COAT, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_CHOICE_BAND, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_CHOICE_BAND, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_BRIGHTPOWDER, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_BRIGHTPOWDER, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_WHITE_HERB, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WHITE_HERB, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_QUICK_CLAW, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_QUICK_CLAW, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SOOTHE_BELL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SOOTHE_BELL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MENTAL_HERB, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MENTAL_HERB, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_KINGS_ROCK, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_KINGS_ROCK, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_AMULET_COIN, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_AMULET_COIN, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_CLEANSE_TAG, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_CLEANSE_TAG, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SMOKE_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SMOKE_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_FOCUS_BAND, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_FOCUS_BAND, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LUCKY_EGG, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LUCKY_EGG, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SCOPE_LENS, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SCOPE_LENS, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LEFTOVERS, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LEFTOVERS, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_SHELL_BELL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_SHELL_BELL, MAX_BAG_ITEM_CAPACITY);
    // if (CheckBagHasSpace(ITEM_MUSCLE_BAND, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MUSCLE_BAND, MAX_BAG_ITEM_CAPACITY);
    // if (CheckBagHasSpace(ITEM_WISE_GLASSES, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_WISE_GLASSES, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_EXPERT_BELT, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_EXPERT_BELT, MAX_BAG_ITEM_CAPACITY);
}

static void DebugAction_PCBag_Fill_PocketPokeBalls(u8 taskId)
{
    if (CheckBagHasSpace(ITEM_POKE_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_POKE_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_GREAT_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_GREAT_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_ULTRA_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_ULTRA_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_MASTER_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_MASTER_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_PREMIER_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_PREMIER_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_NET_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_NET_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_NEST_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_NEST_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_DIVE_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_DIVE_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_TIMER_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_TIMER_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_REPEAT_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_REPEAT_BALL, MAX_BAG_ITEM_CAPACITY);
    if (CheckBagHasSpace(ITEM_LUXURY_BALL, MAX_BAG_ITEM_CAPACITY)) AddBagItem(ITEM_LUXURY_BALL, MAX_BAG_ITEM_CAPACITY);
}
...
static void DebugAction_PCBag_Fill_PocketTMHM(u8 taskId)
{
    ...
    for (itemId = ITEM_HM01; itemId <= ITEM_HM08; itemId++)
    {
        if (CheckBagHasSpace(itemId, 1) && ItemIdToBattleMoveId(itemId) != MOVE_NONE)
            AddBagItem(itemId, 1);
    }
...
static void DebugAction_PCBag_Fill_PocketKeyItems(u8 taskId)
{
        if (CheckBagHasSpace(ITEM_MACH_BIKE, 1)) AddBagItem(ITEM_MACH_BIKE, 1);
        if (CheckBagHasSpace(ITEM_OLD_ROD, 1)) AddBagItem(ITEM_OLD_ROD, 1);
        if (CheckBagHasSpace(ITEM_GOOD_ROD, 1)) AddBagItem(ITEM_GOOD_ROD, 1);
        if (CheckBagHasSpace(ITEM_SUPER_ROD, 1)) AddBagItem(ITEM_SUPER_ROD, 1);
        if (CheckBagHasSpace(ITEM_ITEMFINDER, 1)) AddBagItem(ITEM_ITEMFINDER, 1);
        if (CheckBagHasSpace(ITEM_COIN_CASE, 1)) AddBagItem(ITEM_COIN_CASE, 1);
        if (CheckBagHasSpace(ITEM_POWDER_JAR, 1)) AddBagItem(ITEM_POWDER_JAR, 1);
        if (CheckBagHasSpace(ITEM_WAILMER_PAIL, 1)) AddBagItem(ITEM_WAILMER_PAIL, 1);
        if (CheckBagHasSpace(ITEM_POKEBLOCK_CASE, 1)) AddBagItem(ITEM_POKEBLOCK_CASE, 1);
        if (CheckBagHasSpace(ITEM_SOOT_SACK, 1)) AddBagItem(ITEM_SOOT_SACK, 1);
        if (CheckBagHasSpace(ITEM_EON_TICKET, 1)) AddBagItem(ITEM_EON_TICKET, 1);
        if (CheckBagHasSpace(ITEM_MYSTIC_TICKET, 1)) AddBagItem(ITEM_MYSTIC_TICKET, 1);
        if (CheckBagHasSpace(ITEM_AURORA_TICKET, 1)) AddBagItem(ITEM_AURORA_TICKET, 1);
        if (CheckBagHasSpace(ITEM_OLD_SEA_MAP, 1)) AddBagItem(ITEM_OLD_SEA_MAP, 1);
        if (CheckBagHasSpace(ITEM_GO_GOGGLES, 1)) AddBagItem(ITEM_GO_GOGGLES, 1);
        if (CheckBagHasSpace(ITEM_DEVON_SCOPE, 1)) AddBagItem(ITEM_DEVON_SCOPE, 1);
        if (CheckBagHasSpace(ITEM_BASEMENT_KEY, 1)) AddBagItem(ITEM_BASEMENT_KEY, 1);
        if (CheckBagHasSpace(ITEM_SCANNER, 1)) AddBagItem(ITEM_SCANNER, 1);
        if (CheckBagHasSpace(ITEM_CLAW_FOSSIL, 1)) AddBagItem(ITEM_CLAW_FOSSIL, 1);
        if (CheckBagHasSpace(ITEM_ROOT_FOSSIL, 1)) AddBagItem(ITEM_ROOT_FOSSIL, 1);
        if (CheckBagHasSpace(ITEM_HELIX_FOSSIL, 1)) AddBagItem(ITEM_HELIX_FOSSIL, 1);
        if (CheckBagHasSpace(ITEM_DOME_FOSSIL, 1)) AddBagItem(ITEM_DOME_FOSSIL, 1);
        if (CheckBagHasSpace(ITEM_METEORITE, 1)) AddBagItem(ITEM_METEORITE, 1);
        if (CheckBagHasSpace(ITEM_MAGMA_EMBLEM, 1)) AddBagItem(ITEM_MAGMA_EMBLEM, 1);
        if (CheckBagHasSpace(ITEM_EXP_SHARE, 1)) AddBagItem(ITEM_EXP_SHARE, 1);
        if (CheckBagHasSpace(ITEM_OLD_AMBER, 1)) AddBagItem(ITEM_OLD_AMBER, 1);
        if (CheckBagHasSpace(ITEM_RM_1_KEY, 1)) AddBagItem(ITEM_RM_1_KEY, 1);
}
