...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_REPEL,           {  10,  10,  10,  10,  30,   _,   _,   _,   _,   _, } },
    { ITEM_ESCAPE_ROPE,     {  10,  10,  10,  10,  10,  30,   _,   _,   _,   _, } },
    { ITEM_X_ATTACK,        {  10,  10,  10,  10,  10,  10,  30,   _,   _,   _, } },
    { ITEM_FULL_HEAL,       {   4,  10,  10,  10,  10,  10,  10,  30,   _,   _, } },
    ...
    { ITEM_PROTEIN,         {   _,   _,   _,   4,   4,  10,  10,  10,  10,  10, } },
    { ITEM_ETHER,           {   _,   _,   _,   1,   1,   _,   _,   _,   _,   _, } },
    { ITEM_REVIVE,          {   _,   _,   _,   _,   4,   4,  10,  10,  10,  10, } },
    { ITEM_WHITE_HERB,      {   _,   _,   _,   _,   1,   1,   _,   _,   _,   _, } },
    { ITEM_HP_UP,           {   _,   _,   _,   _,   _,   4,   4,  10,  10,  10, } },
    { ITEM_UPGRADE,         {   _,   _,   _,   _,   _,   1,   1,   _,   _,   _, } },
    { ITEM_ELIXIR,          {   _,   _,   _,   _,   _,   _,   1,   1,   _,   _, } },
    { ITEM_MAX_REVIVE,      {   _,   _,   _,   _,   _,   _,   _,   4,   4,  10, } },
    { ITEM_BRIGHT_POWDER,   {   _,   _,   _,   _,   _,   _,   _,   1,   1,   _, } },
...
// TODO: Re-Add Emerald items with new additions
