...
const u8 gText_ChooseMoveToUse[] = _("Choose a move to use.");
...
const u8 gText_LotadDollAndPrice[] = _("LOTAD DOLL     1,000 COINS");
const u8 gText_SeedotDollAndPrice[] = _("SEEDOT DOLL   1,000 COINS");
...
const u8 gText_MiracleSeedAndPrice[] = _("MIRACLE SEED{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_CharcoalAndPrice[] = _("CHARCOAL{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_MysticWaterAndPrice[] = _("MYSTIC WATER{CLEAR_TO 0x48}1,000 COINS");
...
const u8 gText_KissPoster4BP[] = _("KISS POSTER{CLEAR_TO 0x5E}4BP");
const u8 gText_KissCushion4BP[] = _("KISS CUSHION{CLEAR_TO 0x5E}4BP");
const u8 gText_SmoochumDoll4BP[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}4BP");
const u8 gText_TogepiDoll4BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}4BP");
const u8 gText_MeowthDoll4BP[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}4BP");
const u8 gText_ClefairyDoll4BP[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}4BP");
const u8 gText_DittoDoll4BP[] = _("DITTO DOLL{CLEAR_TO 0x5E}4BP");
const u8 gText_CyndaquilDoll8BP[] = _("CYNDAQUIL DOLL{CLEAR_TO 0x5E}8BP");
const u8 gText_ChikoritaDoll8BP[] = _("CHIKORITA DOLL{CLEAR_TO 0x5E}8BP");
const u8 gText_TotodileDoll8BP[] = _("TOTODILE DOLL{CLEAR_TO 0x5E}8BP");
const u8 gText_LaprasDoll32BP[] = _("LAPRAS DOLL{CLEAR_TO 0x58}32BP");
const u8 gText_SnorlaxDoll32BP[] = _("SNORLAX DOLL{CLEAR_TO 0x58}32BP");
const u8 gText_VenusaurDoll48BP[] = _("VENUSAUR DOLL{CLEAR_TO 0x58}48BP");
const u8 gText_CharizardDoll48BP[] = _("CHARIZARD DOLL{CLEAR_TO 0x58}48BP");
const u8 gText_BlastoiseDoll48BP[] = _("BLASTOISE DOLL{CLEAR_TO 0x58}48BP");
const u8 gText_RegirockDoll64BP[] = _("REGIROCK DOLL{CLEAR_TO 0x58}64BP");
const u8 gText_RegiceDoll64BP[] = _("REGICE DOLL{CLEAR_TO 0x58}64BP");
const u8 gText_RegisteelDoll64BP[] = _("REGISTEEL DOLL{CLEAR_TO 0x58}64BP");
const u8 gText_BlueTent64BP[] = _("BLUE TENT{CLEAR_TO 0x58}64BP");
const u8 gText_RedTent64BP[] = _("RED TENT{CLEAR_TO 0x58}64BP");
const u8 gText_Protein1BP[] = _("5x PROTEIN{CLEAR_TO 0x64}1BP");
const u8 gText_Calcium1BP[] = _("5x CALCIUM{CLEAR_TO 0x64}1BP");
const u8 gText_Iron1BP[] = _("5x IRON{CLEAR_TO 0x64}1BP");
const u8 gText_Zinc1BP[] = _("5x ZINC{CLEAR_TO 0x64}1BP");
const u8 gText_Carbos1BP[] = _("5x CARBOS{CLEAR_TO 0x64}1BP");
...
const u8 gText_Leftovers4BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}4BP");
const u8 gText_WhiteHerb4BP[] = _("WHITE HERB{CLEAR_TO 0x5E}4BP");
const u8 gText_QuickClaw4BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}4BP");
const u8 gText_MentalHerb4BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}4BP");
const u8 gText_BrightPowder8BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}8BP");
const u8 gText_ChoiceBand8BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}8BP");
const u8 gText_FocusBand8BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}8BP");
const u8 gText_ScopeLens8BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}8BP");
const u8 gText_SoulDew128BP[] = _("SOUL DEW{CLEAR_TO 0x5E}128BP");
const u8 gText_Softboiled1BP[] = _("SOFTBOILED{CLEAR_TO 0x4E}1BP");
const u8 gText_SeismicToss2BP[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}2BP");
const u8 gText_DreamEater2BP[] = _("DREAM EATER{CLEAR_TO 0x4E}2BP");
const u8 gText_MegaPunch2BP[] = _("MEGA PUNCH{CLEAR_TO 0x4E}2BP");
const u8 gText_MegaKick4BP[] = _("MEGA KICK{CLEAR_TO 0x4E}4BP");
const u8 gText_BodySlam4BP[] = _("BODY SLAM{CLEAR_TO 0x4E}4BP");
const u8 gText_RockSlide4BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}4BP");
const u8 gText_Counter4BP[] = _("COUNTER{CLEAR_TO 0x4E}4BP");
const u8 gText_ThunderWave4BP[] = _("THUNDER WAVE{CLEAR_TO 0x4E}4BP");
const u8 gText_SwordsDance4BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}4BP");
const u8 gText_DefenseCurl1BP[] = _("DEFENSE CURL{CLEAR_TO 0x4E}1BP");
const u8 gText_Snore2BP[] = _("SNORE{CLEAR_TO 0x4E}2BP");
const u8 gText_MudSlap2BP[] = _("MUD-SLAP{CLEAR_TO 0x4E}2BP");
const u8 gText_Swift2BP[] = _("SWIFT{CLEAR_TO 0x4E}2BP");
const u8 gText_IcyWind2BP[] = _("ICY WIND{CLEAR_TO 0x4E}2BP");
const u8 gText_Endure4BP[] = _("ENDURE{CLEAR_TO 0x4E}4BP");
const u8 gText_PsychUp4BP[] = _("PSYCH UP{CLEAR_TO 0x4E}4BP");
const u8 gText_IcePunch4BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}4BP");
const u8 gText_ThunderPunch4BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}4BP");
const u8 gText_FirePunch4BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}4BP");
...
const u8 gText_GameVersion[] = _("Game Version:\n{STR_VAR_1}");
const u8 gText_SafariBallStock[] = _("SAFARI BALLS\nStock: {STR_VAR_1}");
const u8 gText_BattlePyramidFloor[] = _("Battle Pyramid\n{STR_VAR_1}");
const u8 gText_MenuPreventEncounters[] = _("REPELS");
const u8 gText_MenuSweetScent[] = _("SWEET SCENT");
const u8 gText_MenuAutoRun[] = _("AUTO RUN: {STR_VAR_1}");
const u8 gText_MenuExitDungeon[] = _("EXIT DUNGEON");
const u8 gText_MenuFastTravel[] = _("FAST TRAVEL");
