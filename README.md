# Pokemon Re:Emerald
 ...
 - The main focus of this hack is keeping the battle gameplay ideantical to vanilla Emerald, meaning whatever strategies you used to beat the Battle Facilities on there will work here as well. As such, no newer generation behaviors, stats, effects or the likes will be implemented. Pokemon will also have access to the same exact moves they did on Emerald, everything is just streamlined.
   - If at any point you notice that something doesn't line up with vanilla Emerald in this regard, and it's not documented, do let me know, as it might have been an oversight.
...
# Information links
 ...
 - [Changelog](https://github.com/Dreaker75/re-emerald/blob/development/CHANGELOG.md)
   ...
   - IMPORTANT: Any features under "In-development" will be added to the NEXT version release, you won't be able to play with these features on the latest version. (My idea is to make new releases once enough features have been added and I feel like the new version would improve the gameplay significantly.)
...
# Credits
 ...
 - All the players and playtesters on my Discord, for helping find some bugs I had missed.