...
#define FLAG_TEMP_5      (TEMP_FLAGS_START + 0x5)  // Search for FLAG_TEMP_5 in this file for all its uses
...
#define FLAG_EXP_SHARE_ACTIVE                0x54  // NEW: Flag to know whether the Exp Share is active
...
#define FLAG_RECEIVED_SECOND_DOLL_LANETTE    0x68  // ADDED: To know when both dolls from Lanette have been received
...
#define FLAG_RECEIVED_FIRST_DOLL_LANETTE     0x83
...
#define FLAG_OLDALE_EMPLOYEE_MOVED           0x96 // CHANGED: If true, the mart employee already showed the player to the mart. Used to avoid a walk through walls bug
...
#define FLAG_CAN_TELEPORT                    0xE9 // ADDED: Used to prevent the player from teleporting while doing Battle Frontier challenges and other things
...
#define FLAG_TRICK_HOUSE_RECEIVED_RED_TENT   0x126 // CHANGED: Scanner exchanged flag turned into variable. Now used to know whether the player received the first Tent in the final room of the final Trick Room Puzzle
...
#define FLAG_RECEIVED_FRUSTRATION_TM         0x12B // CHANGED: Pacifidlog Town's NPC changed to give the Frustration TM once like other TM NPCs.
...
#define FLAG_SCOTT_GIVES_CHOICE_BAND         0x1DA // ADDED: Flag to know if Scott gave the Choice Band for having met 13 times

#define FLAG_SHOWN_MYSTIC_TICKET             0x1DB
#define FLAG_DEFEATED_HO_OH                  0x1DC
#define FLAG_DEFEATED_LUGIA                  0x1DD

#define FLAG_FOUGHT_LATIOS_OR_LATIAS_SOUTHERN_BEFORE   0x1DE // Unused Flag
...
#define FLAG_HIDDEN_ITEM_ROUTE_111_MAX_REVIVE                (FLAG_HIDDEN_ITEMS_START + 0x02)
#define FLAG_HIDDEN_ITEM_ROUTE_113_MAX_ELIXIR                (FLAG_HIDDEN_ITEMS_START + 0x03)
...
#define FLAG_HIDDEN_ITEM_ROUTE_123_MAX_REPEL                 (FLAG_HIDDEN_ITEMS_START + 0x07)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_STARDUST             (FLAG_HIDDEN_ITEMS_START + 0x08)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_GREEN_SHARD          (FLAG_HIDDEN_ITEMS_START + 0x09)
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_STAR_PIECE           (FLAG_HIDDEN_ITEMS_START + 0x0A)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_DIVE_BALL            (FLAG_HIDDEN_ITEMS_START + 0x0F)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_STARDUST             (FLAG_HIDDEN_ITEMS_START + 0x10)
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_BIG_PEARL_1          (FLAG_HIDDEN_ITEMS_START + 0x11)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_126_BIG_PEARL_2          (FLAG_HIDDEN_ITEMS_START + 0x14)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_STAR_PIECE           (FLAG_HIDDEN_ITEMS_START + 0x15)
#define FLAG_HIDDEN_ITEM_UNDERWATER_127_MAX_ELIXIR           (FLAG_HIDDEN_ITEMS_START + 0x16)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_128_PP_UP                (FLAG_HIDDEN_ITEMS_START + 0x1A)
...
#define FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_SPELL_TAG          (FLAG_HIDDEN_ITEMS_START + 0x1D)
...
#define FLAG_HIDDEN_ITEM_UNDERWATER_124_PP_UP                (FLAG_HIDDEN_ITEMS_START + 0x24)
...
#define FLAG_HIDDEN_ITEM_ROUTE_121_STAR_PIECE                (FLAG_HIDDEN_ITEMS_START + 0x28)
#define FLAG_HIDDEN_ITEM_ROUTE_123_MAX_REVIVE                (FLAG_HIDDEN_ITEMS_START + 0x29)
#define FLAG_HIDDEN_ITEM_ROUTE_114_MAX_REVIVE                (FLAG_HIDDEN_ITEMS_START + 0x2A)
...
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_B2F_PP_UP              (FLAG_HIDDEN_ITEMS_START + 0x30)
...
#define FLAG_HIDDEN_ITEM_ROUTE_106_NET_BALL                  (FLAG_HIDDEN_ITEMS_START + 0x3F)
#define FLAG_HIDDEN_ITEM_ROUTE_109_ETHER                     (FLAG_HIDDEN_ITEMS_START + 0x40)
#define FLAG_HIDDEN_ITEM_ROUTE_110_SUPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x41)
...
#define FLAG_HIDDEN_ITEM_ROUTE_117_SUPER_REPEL               (FLAG_HIDDEN_ITEMS_START + 0x48)
#define FLAG_HIDDEN_ITEM_ROUTE_121_RARE_CANDY                (FLAG_HIDDEN_ITEMS_START + 0x49)
#define FLAG_HIDDEN_ITEM_ROUTE_123_HYPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x4A)
#define FLAG_HIDDEN_ITEM_LILYCOVE_CITY_NET_BALL              (FLAG_HIDDEN_ITEMS_START + 0x4B)
...
#define FLAG_HIDDEN_ITEM_MT_PYRE_EXTERIOR_MAX_ELIXIR         (FLAG_HIDDEN_ITEMS_START + 0x4E)
...
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_1F_FULL_RESTORE        (FLAG_HIDDEN_ITEMS_START + 0x51)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_MAX_REVIVE         (FLAG_HIDDEN_ITEMS_START + 0x52)
#define FLAG_HIDDEN_ITEM_VICTORY_ROAD_B2F_MAX_REPEL          (FLAG_HIDDEN_ITEMS_START + 0x53)
#define FLAG_HIDDEN_ITEM_ROUTE_120_MAX_REVIVE                (FLAG_HIDDEN_ITEMS_START + 0x54)
#define FLAG_HIDDEN_ITEM_ROUTE_104_HEART_SCALE_1             (FLAG_HIDDEN_ITEMS_START + 0x55)
...
#define FLAG_HIDDEN_ITEM_ROUTE_104_HEART_SCALE_2             (FLAG_HIDDEN_ITEMS_START + 0x58)
...
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_PP_MAX             (FLAG_HIDDEN_ITEMS_START + 0x65)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_SACRED_ASH         (FLAG_HIDDEN_ITEMS_START + 0x66)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_OLD_AMBER          (FLAG_HIDDEN_ITEMS_START + 0x67)
#define FLAG_HIDDEN_ITEM_ARTISAN_CAVE_B1F_STAR_PIECE         (FLAG_HIDDEN_ITEMS_START + 0x68)
...
#define FLAG_SWARMS_START                                   0x264
#define FLAG_CATERPIE_SPECIES_SWARMING                      (FLAG_SWARMS_START + 0x00)
#define FLAG_WEEDLE_SPECIES_SWARMING                        (FLAG_CATERPIE_SPECIES_SWARMING + 0x1)
#define FLAG_PIDGEY_SPECIES_SWARMING                        (FLAG_WEEDLE_SPECIES_SWARMING + 0x1)
#define FLAG_RATTATA_SPECIES_SWARMING                       (FLAG_PIDGEY_SPECIES_SWARMING + 0x1)
#define FLAG_SPEAROW_SPECIES_SWARMING                       (FLAG_RATTATA_SPECIES_SWARMING + 0x1)
#define FLAG_EKANS_SPECIES_SWARMING                         (FLAG_SPEAROW_SPECIES_SWARMING + 0x1)
#define FLAG_NIDORAN_SPECIES_SWARMING                       (FLAG_EKANS_SPECIES_SWARMING + 0x1)
#define FLAG_CLEFAIRY_SPECIES_SWARMING                      (FLAG_NIDORAN_SPECIES_SWARMING + 0x1)
#define FLAG_MEOWTH_SPECIES_SWARMING                        (FLAG_CLEFAIRY_SPECIES_SWARMING + 0x1)  // Also a trade
#define FLAG_MANKEY_SPECIES_SWARMING                        (FLAG_MEOWTH_SPECIES_SWARMING + 0x1)
#define FLAG_GROWLITHE_SPECIES_SWARMING                     (FLAG_MANKEY_SPECIES_SWARMING + 0x1)
#define FLAG_POLIWAG_SPECIES_SWARMING                       (FLAG_GROWLITHE_SPECIES_SWARMING + 0x1)
#define FLAG_BELLSPROUT_SPECIES_SWARMING                    (FLAG_POLIWAG_SPECIES_SWARMING + 0x1)
#define FLAG_PONYTA_SPECIES_SWARMING                        (FLAG_BELLSPROUT_SPECIES_SWARMING + 0x1)
#define FLAG_SLOWPOKE_SPECIES_SWARMING                      (FLAG_PONYTA_SPECIES_SWARMING + 0x1)
#define FLAG_SEEL_SPECIES_SWARMING                          (FLAG_SLOWPOKE_SPECIES_SWARMING + 0x1)
#define FLAG_SHELLDER_SPECIES_SWARMING                      (FLAG_SEEL_SPECIES_SWARMING + 0x1)
#define FLAG_GASTLY_SPECIES_SWARMING                        (FLAG_SHELLDER_SPECIES_SWARMING + 0x1)
#define FLAG_ONIX_SPECIES_SWARMING                          (FLAG_GASTLY_SPECIES_SWARMING + 0x1)
#define FLAG_DROWZEE_SPECIES_SWARMING                       (FLAG_ONIX_SPECIES_SWARMING + 0x1)
#define FLAG_KRABBY_SPECIES_SWARMING                        (FLAG_DROWZEE_SPECIES_SWARMING + 0x1)
#define FLAG_EXEGGCUTE_SPECIES_SWARMING                     (FLAG_KRABBY_SPECIES_SWARMING + 0x1)
#define FLAG_CUBONE_SPECIES_SWARMING                        (FLAG_EXEGGCUTE_SPECIES_SWARMING + 0x1)
#define FLAG_LICKITUNG_SPECIES_SWARMING                     (FLAG_CUBONE_SPECIES_SWARMING + 0x1)
#define FLAG_CHANSEY_SPECIES_SWARMING                       (FLAG_LICKITUNG_SPECIES_SWARMING + 0x1)
#define FLAG_TANGELA_SPECIES_SWARMING                       (FLAG_CHANSEY_SPECIES_SWARMING + 0x1)
#define FLAG_KANGASKHAN_SPECIES_SWARMING                    (FLAG_TANGELA_SPECIES_SWARMING + 0x1)
#define FLAG_SCYTHER_SPECIES_SWARMING                       (FLAG_KANGASKHAN_SPECIES_SWARMING + 0x1)
#define FLAG_JYNX_SPECIES_SWARMING                          (FLAG_SCYTHER_SPECIES_SWARMING + 0x1)
#define FLAG_ELECTABUZZ_SPECIES_SWARMING                    (FLAG_JYNX_SPECIES_SWARMING + 0x1)
#define FLAG_MAGMAR_SPECIES_SWARMING                        (FLAG_ELECTABUZZ_SPECIES_SWARMING + 0x1)
#define FLAG_LAPRAS_SPECIES_SWARMING                        (FLAG_MAGMAR_SPECIES_SWARMING + 0x1)
#define FLAG_DRATINI_SPECIES_SWARMING                       (FLAG_LAPRAS_SPECIES_SWARMING + 0x1)
#define FLAG_SENTRET_SPECIES_SWARMING                       (FLAG_DRATINI_SPECIES_SWARMING + 0x1)
#define FLAG_HOOTHOOT_SPECIES_SWARMING                      (FLAG_SENTRET_SPECIES_SWARMING + 0x1)
#define FLAG_LEDYBA_SPECIES_SWARMING                        (FLAG_HOOTHOOT_SPECIES_SWARMING + 0x1)
#define FLAG_SPINARAK_SPECIES_SWARMING                      (FLAG_LEDYBA_SPECIES_SWARMING + 0x1)
#define FLAG_MAREEP_SPECIES_SWARMING                        (FLAG_SPINARAK_SPECIES_SWARMING + 0x1)  // Also in Safari Zone
#define FLAG_HOPPIP_SPECIES_SWARMING                        (FLAG_MAREEP_SPECIES_SWARMING + 0x1)
#define FLAG_MURKROW_SPECIES_SWARMING                       (FLAG_HOPPIP_SPECIES_SWARMING + 0x1)
#define FLAG_MISDREAVUS_SPECIES_SWARMING                    (FLAG_MURKROW_SPECIES_SWARMING + 0x1)
#define FLAG_DUNSPARCE_SPECIES_SWARMING                     (FLAG_MISDREAVUS_SPECIES_SWARMING + 0x1)
#define FLAG_GLIGAR_SPECIES_SWARMING                        (FLAG_DUNSPARCE_SPECIES_SWARMING + 0x1) // Was in Safari Zone before
#define FLAG_SNEASEL_SPECIES_SWARMING                       (FLAG_GLIGAR_SPECIES_SWARMING + 0x1)
#define FLAG_REMORAID_SPECIES_SWARMING                      (FLAG_SNEASEL_SPECIES_SWARMING + 0x1)  // Also in Safari Zone
#define FLAG_MANTINE_SPECIES_SWARMING                       (FLAG_REMORAID_SPECIES_SWARMING + 0x1)
#define FLAG_HOUNDOUR_SPECIES_SWARMING                      (FLAG_MANTINE_SPECIES_SWARMING + 0x1)  // Was in Safari Zone before
#define FLAG_SWARMS_END                                     FLAG_HOUNDOUR_SPECIES_SWARMING
#define NUM_SWARMS_FLAGS                                    (FLAG_SWARMS_END - FLAG_SWARMS_START + 1)
...
#define FLAG_UNUSED_0x384                                           0x3B4 // CHANGED: Previously used to show the Secret Power Shop NPC on Slateport
...
#define FLAG_ITEM_ROUTE_112_FIRE_STONE                              0x3F3
...
#define FLAG_ITEM_ROUTE_117_NEST_BALL                               0x3FE
#define FLAG_ITEM_ROUTE_117_REVIVE                                  0x3FF
#define FLAG_ITEM_ROUTE_119_MAX_REPEL                               0x400
...
#define FLAG_ITEM_ROUTE_119_SILVER_POWDER                           0x405
#define FLAG_ITEM_ROUTE_120_SHARP_BEAK                              0x406
#define FLAG_ITEM_ROUTE_120_WATER_STONE                             0x407
#define FLAG_ITEM_ROUTE_123_CALCIUM                                 0x408
#define FLAG_ITEM_MOSSDEEP_CITY_TWISTEDSPOON                        0x409 // ADDED: New item on Mossdeep City
...
#define FLAG_ITEM_ROUTE_104_NEST_BALL                               0x421
...
#define FLAG_ITEM_AQUA_HIDEOUT_B2F_DIVE_BALL                        0x430
#define FLAG_ITEM_MT_PYRE_EXTERIOR_FULL_RESTORE                     0x431
...
#define FLAG_ITEM_SHOAL_CAVE_STAIRS_ROOM_FULL_HEAL                  0x43B
#define FLAG_ITEM_VICTORY_ROAD_1F_MAX_ELIXIR                        0x43C
#define FLAG_ITEM_VICTORY_ROAD_1F_TM_FLAMETHROWER                   0x43D
#define FLAG_ITEM_VICTORY_ROAD_B1F_TM_PSYCHIC                       0x43E
#define FLAG_ITEM_VICTORY_ROAD_B1F_FULL_RESTORE                     0x43F
#define FLAG_ITEM_VICTORY_ROAD_B2F_DRAGON_FANG                      0x440
...
#define FLAG_ITEM_ABANDONED_SHIP_ROOMS_1F_BIG_PEARL                 0x447
...
#define FLAG_ITEM_ROUTE_119_HYPER_POTION                            0x452
#define FLAG_ITEM_ROUTE_120_MAX_POTION                              0x453
#define FLAG_ITEM_ROUTE_120_TIMER_BALL                              0x454
#define FLAG_ITEM_ROUTE_123_MAX_ELIXIR                              0x455
...
#define FLAG_ITEM_ROUTE_115_ULTRA_BALL                              0x45E
#define FLAG_ITEM_SAFARI_ZONE_NORTH_CALCIUM                         0x45F
#define FLAG_ITEM_MT_PYRE_3F_MAX_REPEL                              0x460
...
#define FLAG_ITEM_MOSSDEEP_CITY_STAR_PIECE                          0x468 // ADDED: New item on Mossdeep City
#define FLAG_ITEM_MT_PYRE_2F_ULTRA_BALL                             0x469
#define FLAG_ITEM_MT_PYRE_4F_SEA_INCENSE                            0x46A
#define FLAG_ITEM_SAFARI_ZONE_SOUTH_WEST_MAX_REVIVE                 0x46B
#define FLAG_ITEM_AQUA_HIDEOUT_B1F_STAR_PIECE                       0x46C
#define FLAG_ITEM_SAFARI_ZONE_SOUTH_POISON_BARB                     0x46D // ADDED: New item in Safari Zone
#define FLAG_ITEM_ROUTE_119_NUGGET                                  0x46E
#define FLAG_ITEM_ROUTE_104_POTION                                  0x46F
#define FLAG_UNUSED_0x470                                           0x470 // Unused Flag
#define FLAG_ITEM_ROUTE_103_PP_UP                                   0x471
#define FLAG_UNUSED_0x472                                           0x472 // Unused Flag
#define FLAG_ITEM_ROUTE_108_WATER_STONE                             0x473
#define FLAG_ITEM_ROUTE_109_SUPER_POTION                            0x474
#define FLAG_ITEM_ROUTE_110_THUNDERSTONE                            0x475
#define FLAG_ITEM_ROUTE_111_ELIXIR                                  0x476
#define FLAG_ITEM_ROUTE_113_HYPER_POTION                            0x477
#define FLAG_ITEM_ROUTE_115_HYPER_POTION                            0x478
#define FLAG_UNUSED_0x479                                           0x479 // Unused Flag
#define FLAG_ITEM_ROUTE_116_NEST_BALL                               0x47A
#define FLAG_ITEM_ROUTE_119_ELIXIR_2                                0x47B
#define FLAG_ITEM_ROUTE_120_MAX_REVIVE                              0x47C
#define FLAG_ITEM_ROUTE_121_PP_UP                                   0x47D
...
#define FLAG_ITEM_ROUTE_114_BLACK_BELT                              0x488
#define FLAG_ITEM_ROUTE_115_PP_UP                                   0x489
#define FLAG_ITEM_ARTISAN_CAVE_B1F_RARE_CANDY                       0x48A
#define FLAG_ITEM_ARTISAN_CAVE_1F_PREMIER_BALL                      0x48B
...
// Custom Flags
// Permanently removable rocks
#define FLAG_HIDE_ROUTE_111_ROCK_1                                  0x493
#define FLAG_HIDE_ROUTE_111_ROCK_2                                  0x494
#define FLAG_HIDE_ROUTE_114_ROCK_1                                  0x495
#define FLAG_HIDE_ROUTE_114_ROCK_2                                  0x496
#define FLAG_HIDE_ROUTE_114_ROCK_3                                  0x497
#define FLAG_HIDE_ROUTE_114_ROCK_4                                  0x498
#define FLAG_HIDE_ROUTE_114_ROCK_5                                  0x499
#define FLAG_HIDE_ROUTE_115_ROCK_1                                  0x49A
#define FLAG_HIDE_ROUTE_115_ROCK_2                                  0x49B // New breakable rock added for easier backtracking (Needs Strength too, to prevent early access)
#define FLAG_HIDE_SEAFLOOR_CAVERN_ROCK_1                            0x49C
#define FLAG_HIDE_SEAFLOOR_CAVERN_ROCK_2                            0x49D
#define FLAG_HIDE_SEAFLOOR_CAVERN_ROCK_3                            0x49E
#define FLAG_HIDE_SEAFLOOR_CAVERN_ROCK_4                            0x49F
#define FLAG_HIDE_SEAFLOOR_CAVERN_ROCK_5                            0x4A0
#define FLAG_HIDE_VICTORY_ROAD_ROCK_1                               0x4A1
#define FLAG_HIDE_VICTORY_ROAD_ROCK_2                               0x4A2
#define FLAG_HIDE_VICTORY_ROAD_ROCK_3                               0x4A3
#define FLAG_HIDE_VICTORY_ROAD_ROCK_4                               0x4A4
...
#define FLAG_SYS_IS_RUNNING_TOGGLED                 (SYSTEM_FLAGS + 0x83) // ADDED: If true, player runs by default
