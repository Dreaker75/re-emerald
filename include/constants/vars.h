...
#define VAR_LOTTERY_RNG_TIMES                            0x404E // ADDED: Variable to indicate how many times the number will be randomized. Replaces the days used before so a new number can be generated every time the Elite Four is beaten.
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_SCANNER_EXCHANGE_STATE                       0x4052 // ADDED: 0 - Scanner not given, 1 - Scanner given, 2 - DeepSeaTooth received, 3 - DeepSeaScale received
...
#define VAR_LAST_REPEL_USED                              0x40A1 // Stores the last Repel item used
...
// Variables used on Fossil Revival
#define VAR_TEMP_SELECTED_ITEM        VAR_TEMP_0
