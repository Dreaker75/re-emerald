...
#define PARTY_MSG_CHOOSE_A_MOVE_TO_USE      12
#define PARTY_MSG_ALREADY_IN_USE            13
#define PARTY_MSG_CANT_USE_HERE             14
#define PARTY_MSG_NO_MON_FOR_BATTLE         15
#define PARTY_MSG_CHOOSE_MON_2              16
#define PARTY_MSG_NOT_ENOUGH_HP             17
#define PARTY_MSG_X_MONS_ARE_NEEDED         18
...
#define SELECTWINDOW_USE_A_MOVE  3
#define SELECTWINDOW_OTHER_MOVES 4
#define SELECTWINDOW_MOVES       5
#define SELECTWINDOW_CATALOG     6
#define SELECTWINDOW_ZYGARDECUBE 7
