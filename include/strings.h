...
extern const u8 gText_AskToUseFlash[];
...
extern const u8 gText_KissPoster4BP[];
extern const u8 gText_KissCushion4BP[];
extern const u8 gText_SmoochumDoll4BP[];
extern const u8 gText_TogepiDoll4BP[];
extern const u8 gText_MeowthDoll4BP[];
extern const u8 gText_ClefairyDoll4BP[];
extern const u8 gText_DittoDoll4BP[];
extern const u8 gText_CyndaquilDoll8BP[];
extern const u8 gText_ChikoritaDoll8BP[];
extern const u8 gText_TotodileDoll8BP[];

extern const u8 gText_LaprasDoll32BP[];
extern const u8 gText_SnorlaxDoll32BP[];
extern const u8 gText_VenusaurDoll48BP[];
extern const u8 gText_CharizardDoll48BP[];
extern const u8 gText_BlastoiseDoll48BP[];
extern const u8 gText_RegirockDoll64BP[];
extern const u8 gText_RegiceDoll64BP[];
extern const u8 gText_RegisteelDoll64BP[];
extern const u8 gText_BlueTent64BP[];
extern const u8 gText_RedTent64BP[];
...
extern const u8 gText_Leftovers4BP[];
extern const u8 gText_WhiteHerb4BP[];
extern const u8 gText_QuickClaw4BP[];
extern const u8 gText_MentalHerb4BP[];
extern const u8 gText_BrightPowder8BP[];
extern const u8 gText_ChoiceBand8BP[];
extern const u8 gText_KingsRock1BP[];
extern const u8 gText_FocusBand8BP[];
extern const u8 gText_ScopeLens8BP[];
extern const u8 gText_SoulDew128BP[];
...
extern const u8 gText_Softboiled1BP[];
extern const u8 gText_SeismicToss2BP[];
extern const u8 gText_DreamEater2BP[];
extern const u8 gText_MegaPunch2BP[];
extern const u8 gText_MegaKick4BP[];
extern const u8 gText_BodySlam4BP[];
extern const u8 gText_RockSlide4BP[];
extern const u8 gText_Counter4BP[];
extern const u8 gText_ThunderWave4BP[];
extern const u8 gText_SwordsDance4BP[];
extern const u8 gText_DefenseCurl1BP[];
extern const u8 gText_Snore2BP[];
extern const u8 gText_MudSlap2BP[];
extern const u8 gText_Swift2BP[];
extern const u8 gText_IcyWind2BP[];
extern const u8 gText_Endure4BP[];
extern const u8 gText_PsychUp4BP[];
extern const u8 gText_IcePunch4BP[];
extern const u8 gText_ThunderPunch4BP[];
extern const u8 gText_FirePunch4BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlueTentDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RedTentDesc[];
...
extern const u8 gText_LotadDollAndPrice[];
extern const u8 gText_SeedotDollAndPrice[];
extern const u8 gText_SilkScarfAndPrice[];
extern const u8 gText_MiracleSeedAndPrice[];
extern const u8 gText_CharcoalAndPrice[];
extern const u8 gText_MysticWaterAndPrice[];
...
extern const u8 gText_ChooseMoveToUse[];
...
extern const u8 gText_OtherMoves[];
