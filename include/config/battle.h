...
#define B_KINGS_SHIELD_LOWER_ATK    GEN_3 // In Gen8+, it lowers Atk by 1 stage instead of 2 of oponents that hit it.
...
// Gives an error when set to GEN_3
...
#define B_SYNCHRONIZE_NATURE        GEN_3 // In Gen8, if a Pokémon with Synchronize is leading the party, it's 100% guaranteed that wild Pokémon will have the same Nature, as opposed to 50% previously.
