...
#define OW_RUNNING_EVERYWHERE       TRUE        // ADDED: If TRUE, allows running indoors and also ignores Metatiles limitations on running
...
#define OW_MAGNET_PULL              GEN_3      // Prior to Gen9, if a Pokémon with Magnet Pull is leading the party, there is a 50% chance to encounter a Steel-type Pokémon.
#define OW_STATIC                   GEN_3      // Prior to Gen9, if a Pokémon with Static is leading the party, there is a 50% chance to encounter an Electric-type Pokémon.
