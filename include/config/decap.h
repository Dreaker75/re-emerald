...
#define DECAP_MAIN_MENU     FALSE // Main menu text.
#define DECAP_OPTION_MENU   FALSE // Option menu text.
#define DECAP_START_MENU    FALSE // Start menu options & Save menu text.
#define DECAP_PARTY_MENU    FALSE // Party menu text.
#define DECAP_MAP_NAMES     FALSE // Map and location names.
#define DECAP_EASY_CHAT     FALSE // Easy Chat words and interface.
#define DECAP_FIELD_MSG     FALSE // Field messages (including scripts!).
#define DECAP_SUMMARY       FALSE // Summary interface text.
